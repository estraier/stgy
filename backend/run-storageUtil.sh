...
then
   ...
   ts-node src/storageUtil.ts head fakebook-test:/test-package.json
   ts-node src/storageUtil.ts copy fakebook-test:/test-package.json fakebook-test:/test-package-copied.json
   ts-node src/storageUtil.ts head fakebook-test:/test-package-copied.json
   ts-node src/storageUtil.ts move fakebook-test:/test-package-copied.json fakebook-test:/test-package-moved.json
   ts-node src/storageUtil.ts head fakebook-test:/test-package-moved.json
   ts-node src/storageUtil.ts delete fakebook-test:/test-package.json
   ts-node src/storageUtil.ts delete fakebook-test:/test-package-moved.json
