export class Config {
  ...
  static readonly MEDIA_THUMB_MAX_PIXELS_IMAGE = envNum("FAKEBOOK_MEDIA_THUMB_MAX_PIXELS_IMAGE", 512 * 512);
  static readonly MEDIA_THUMB_MAX_PIXELS_ICON = envNum("FAKEBOOK_MEDIA_THUMB_MAX_PIXELS_ICON", 96 * 96);
  ...
  static readonly NOTIFICATION_BATCH_SIZE = envNum("FAKEBOOK_NOTIFICATION_BATCH_SIZE", 1000);
