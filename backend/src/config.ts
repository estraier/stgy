export class Config {
  ...
  static readonly HOURLY_USER_UPDATES_LIMIT = envNum("STGY_HOURLY_USER_UPDATES_LIMIT", 60);
  static readonly HOURLY_POSTS_LIMIT = envNum("STGY_HOURLY_POSTS_LIMIT", 60);
  static readonly HOURLY_LIKES_LIMIT = envNum("STGY_HOURLY_LIKES_LIMIT", 60);
  static readonly HOURLY_IMAGE_POSTS_LIMIT = envNum("STGY_HOURLY_IMAGE_POSTS_LIMIT", 60);
