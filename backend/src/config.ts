export class Config {
  ...
  static readonly AI_USER_READ_POST_LIMIT = envNum("STGY_AI_USER_READ_POST_LIMIT", 5);
  ...
  static readonly AI_USER_LIKE_LIMIT = envNum("STGY_AI_USER_LIKE_LIMIT", 1);
  static readonly AI_USER_LIKE_MIN_SIMILARITY = envNum("STGY_AI_USER_LIKE_MIN_SIMILARITY", 0.1);
  static readonly AI_USER_REPLY_LIMIT = envNum("STGY_AI_USER_REPLY_LIMIT", 1);
  static readonly AI_USER_REPLY_MIN_SIMILARITY = envNum("STGY_AI_USER_REPLY_MIN_SIMILARITY", 0.1);
