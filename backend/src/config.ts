...
export class Config {
  ...
  static readonly MEDIA_TRACK_JSON_BYTE_LIMIT = envNum(
    "STGY_MEDIA_TRACK_JSON_BYTE_LIMIT",
    10 * 1024 * 1024,
  );
  static readonly MEDIA_TRACK_JSON_FEATURE_LIMIT = envNum(
    "STGY_MEDIA_TRACK_JSON_FEATURE_LIMIT",
    100,
  );
  static readonly MEDIA_TRACK_JSON_POINT_LIMIT = envNum(
    "STGY_MEDIA_TRACK_JSON_POINT_LIMIT",
    100000,
  );
  static readonly MEDIA_TRACK_JSON_PROPERTY_VALUE_LIMIT = envNum(
    "STGY_MEDIA_TRACK_JSON_PROPERTY_VALUE_LIMIT",
    1000000,
  );
  static readonly MEDIA_TRACK_JSON_DEPTH_LIMIT = envNum(
    "STGY_MEDIA_TRACK_JSON_DEPTH_LIMIT",
    32,
  );
  ...
  static readonly HOURLY_USER_UPDATES_COUNT_LIMIT = envNum(
    "STGY_HOURLY_USER_UPDATES_COUNT_LIMIT",
    60,
  );
  static readonly HOURLY_USER_UPDATES_SIZE_LIMIT = envNum(
    "STGY_HOURLY_USER_UPDATES_SIZE_LIMIT",
    1 * 1000 * 1000,
  );
  static readonly HOURLY_POSTS_COUNT_LIMIT = envNum("STGY_HOURLY_POSTS_COUNT_LIMIT", 60);
  static readonly HOURLY_POSTS_SIZE_LIMIT = envNum("STGY_HOURLY_POSTS_SIZE_LIMIT", 2 * 1000 * 1000);
  static readonly HOURLY_LIKES_COUNT_LIMIT = envNum("STGY_HOURLY_LIKES_COUNT_LIMIT", 60);
  static readonly HOURLY_IMAGE_POSTS_COUNT_LIMIT = envNum(
    "STGY_HOURLY_IMAGE_POSTS_COUNT_LIMIT",
    60,
  );
  ...
  static readonly NOTIFICATION_BUFFER_FLUSH_MS = envNum(
    "STGY_NOTIFICATION_BUFFER_FLUSH_MS",
    10 * 1000,
  );
  static readonly NOTIFICATION_BUFFER_MAX_EVENTS = envNum(
    "STGY_NOTIFICATION_BUFFER_MAX_EVENTS",
    10000,
  );
  ...
  static readonly LINK_SNIPPET_FAILURE_TTL_SEC = envNum(
    "STGY_LINK_SNIPPET_FAILURE_TTL_SEC",
    30 * 60,
  );
  static readonly LINK_SNIPPET_FETCH_TIMEOUT_MS = envNum(
    "STGY_LINK_SNIPPET_FETCH_TIMEOUT_MS",
    10 * 1000,
  );
  static readonly LINK_SNIPPET_MAX_HTML_BYTES = envNum(
    "STGY_LINK_SNIPPET_MAX_HTML_BYTES",
    512 * 1024,
  );
  static readonly LINK_SNIPPET_MAX_REDIRECTS = envNum("STGY_LINK_SNIPPET_MAX_REDIRECTS", 3);
  static readonly LINK_SNIPPET_TITLE_LENGTH_LIMIT = envNum(
    "STGY_LINK_SNIPPET_TITLE_LENGTH_LIMIT",
    120,
  );
  static readonly LINK_SNIPPET_DESCRIPTION_LENGTH_LIMIT = envNum(
    "STGY_LINK_SNIPPET_DESCRIPTION_LENGTH_LIMIT",
    240,
  );
  static readonly LINK_SNIPPET_SITE_NAME_LENGTH_LIMIT = envNum(
    "STGY_LINK_SNIPPET_SITE_NAME_LENGTH_LIMIT",
    80,
  );
  static readonly LINK_SNIPPET_CLIENT_FETCH_LIMIT_PER_HOUR = envNum(
    "STGY_LINK_SNIPPET_CLIENT_FETCH_LIMIT_PER_HOUR",
    60,
  );
  static readonly LINK_SNIPPET_GLOBAL_FETCH_LIMIT_PER_MIN = envNum(
    "STGY_LINK_SNIPPET_GLOBAL_FETCH_LIMIT_PER_MIN",
    120,
  );
  static readonly LINK_SNIPPET_HOST_FETCH_LIMIT_PER_MIN = envNum(
    "STGY_LINK_SNIPPET_HOST_FETCH_LIMIT_PER_MIN",
    10,
  );
  static readonly LINK_SNIPPET_ADDRESS_FETCH_LIMIT_PER_MIN = envNum(
    "STGY_LINK_SNIPPET_ADDRESS_FETCH_LIMIT_PER_MIN",
    20,
  );
  ...
  static readonly AI_SUMMARY_POST_TEXT_LIMIT = envNum("STGY_AI_SUMMARY_POST_TEXT_LIMIT", 50000);
  ...
  static readonly AI_USER_REPLY_CHAIN_LIMIT = 5;
  static readonly AI_USER_REPLY_CHAIN_POST_TEXT_LIMIT = 3000;
  static readonly AI_USER_EXISTING_REPLIES_TO_POST_LIMIT = 5;
  static readonly AI_USER_EXISTING_REPLIES_TO_POST_TEXT_LIMIT = 1000;
  ...
  static readonly AI_USER_IMPRESSION_PEER_TEXT_LIMIT = envNum(
    "STGY_AI_USER_IMPRESSION_PEER_TEXT_LIMIT",
    2000,
  );
  static readonly AI_USER_IMPRESSION_LENGTH = envNum("STGY_AI_USER_IMPRESSION_LENGTH", 1000);
  static readonly AI_USER_INTEREST_LENGTH = envNum("STGY_AI_USER_INTEREST_LENGTH", 2000);
  static readonly AI_USER_INTEREST_HYSTERESIS_COEFFICIENT = envNum(
    "STGY_AI_USER_INTEREST_HYSTERESIS_COEFFICIENT",
    0.5,
  );
  ...
  static readonly AI_USER_SKIP_INTEREST_UPDATE_DAYS = envNum(
    "STGY_AI_USER_SKIP_INTEREST_UPDATE_DAYS",
    0,
  );
  static readonly AI_USER_SKIP_NEW_POST_DAYS = envNum("STGY_AI_USER_SKIP_NEW_POST_DAYS", 1);
