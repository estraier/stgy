import { renderText, renderHtml, parseMarkdownBlocks } from "./markdown";

describe("renderText basics", () => {
  it("empty body", () => {
    const mdText = "";
    expect(renderText(mdText)).toBe("");
  });

  it("paragraph", () => {
    const mdText = "hello world";
    expect(renderText(mdText)).toBe("hello world");
  });
...
abc`;
    expect(renderText(mdText)).toBe(expected);
  });
});
...
describe("parseMarkdownBlocks basics", () => {
  it("various formats", () => {
    const mdText = `# H1
abc
def
...
`;
    const expected =
      '[{"type":"element","tag":"h1","children":[{"type":"text","text":"H1"}]},{"type":"element","tag":"p","children":[{"type":"text","text":"abc"},{"type":"element","tag":"br","children":[]},{"type":"text","text":"def"}]},{"type":"element","tag":"figure","attrs":" class=\\"image-block\\"","children":[{"type":"element","tag":"img","attrs":" src=\\"/data/def/ghi\\" alt=\\"\\" data-thumbnail","children":[]},{"type":"element","tag":"figcaption","children":[{"type":"text","text":"abc"}]}]},{"type":"element","tag":"h3","children":[{"type":"text","text":"H3"}]}]';
    const result = parseMarkdownBlocks(mdText);
