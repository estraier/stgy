INSERT INTO users (
  ...
  'volume test user', 'dummy', 'test', now()
);

INSERT INTO posts (id, content, owned_by, reply_to, created_at) VALUES
  ('00000000-0000-0000-0002-000000000101', 'taroの投稿その1', '00000000-0000-0000-0001-000000000101', NULL, now()),
  ('00000000-0000-0000-0002-000000000102', 'taroの投稿その2', '00000000-0000-0000-0001-000000000101', NULL, now());
