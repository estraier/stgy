export class Config {
  ...
  static readonly PUB_POSTS_SNIPPET_PAGE_SIZE = normNum(process.env.NEXT_PUBLIC_PUB_POSTS_SNIPPET_PAGE_SIZE, 10);
  static readonly PUB_POSTS_PLAIN_PAGE_SIZE = normNum(process.env.NEXT_PUBLIC_PUB_POSTS_PLAIN_PAGE_SIZE, 100);
