...
CFG_STGY_REDIS_PASSWORD="${STGY_REDIS_PASSWORD:-stgystgy}"
CFG_STGY_REDIS_PASSWORD_B64="$(printf %s "$CFG_STGY_REDIS_PASSWORD" | base64 | tr -d '\n')"
# ========================================================================
...
export NEXT_PUBLIC_FRONTEND_CANONICAL_URL="__CFG_NEXT_PUBLIC_FRONTEND_CANONICAL_URL__"
...
export STGY_REDIS_PASSWORD="$(printf %s '__CFG_STGY_REDIS_PASSWORD_B64__' | base64 -d)"
# ============================================================
...
sed -i \
  ...
  -e "s#__CFG_NEXT_PUBLIC_FRONTEND_CANONICAL_URL__#${CFG_NEXT_PUBLIC_FRONTEND_CANONICAL_URL}#g" \
  ...
  -e "s#__CFG_STGY_REDIS_PASSWORD_B64__#${CFG_STGY_REDIS_PASSWORD_B64}#g" \
  "$TARGET/start.sh"
